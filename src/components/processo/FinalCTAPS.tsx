      ...
      <div className="relative z-10 max-w-[700px] mx-auto text-center">
        ...
        <motion.div initial={{opacity:0,scale:.92}} animate={inView?{opacity:1,scale:1}:{}} transition={{delay:.32,duration:.5}}
          ...
          <p className="font-dm text-[rgba(253,251,247,.4)] text-sm">
            Dúvidas?{" "}
            <a href="https://wa.me/5531987577892" target="_blank" rel="noopener noreferrer" className="text-[#C84B31] hover:underline">Fale com a equipe de seleção</a>
            {" "}ou{" "}
            <Link href="/formacao" className="text-[#C84B31] hover:underline">acesse os materiais de preparação.</Link>
          </p>
        </motion.div>
      </div>
    </section>
